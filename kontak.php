                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="bradcaump__inner text-center">
                        	<h2 class="bradcaump-title">Kontak Kami</h2>
        		...
        		<div class="row">
        			<div class="col-lg-8 col-12">
        				<div class="contact-form-wrap">
        					<h2 class="contact__title">Ingin lebih dekat dengan kami</h2>
							<p>Anda memiliki pesan atau saran keapada PedoS, anda dapat mengirimnya melalui tahap berikut ini</p>
							<form action="Send_email.php" method="post">
                                ...
                                <div class="single-contact-form message">
                                    <textarea name="pesan" placeholder="Ketik pesan anda disini.."></textarea>
                                </div>
        			...
        			<div class="col-lg-4 col-12 md-mt-40 sm-mt-40">
        				<div class="wn__address">
        					<h2 class="contact__title">Info Kantor Kami.</h2>
