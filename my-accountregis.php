				...
				<div class="row">
					<div class="col-lg-6 col-12">
						<div class="my__account__wrapper">
							...
							<p>Jika anda belum memiliki akun, daftar lah terlebih dahulu melalui tahap berikut</p>
							<form action="prosesdaftar.php" method="POST">
								<div class="account__form">
									...
									<button class="btn btn--md btn--round register_btn" type="submit">Daftar</button>
									</div>
								</div>
							</form>
						</div>	
